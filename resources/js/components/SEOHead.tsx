...
export default function SEOHead({
  ...
  const resolvedSiteName = siteName || settings?.appName || "Etalase UMKM Digital";
  const canonicalUrl = url || (typeof window !== "undefined" ? window.location.origin + window.location.pathname : "https://serasa.levitation.web.id/");
