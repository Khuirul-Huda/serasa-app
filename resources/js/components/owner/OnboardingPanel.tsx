      ...
      <div className="bg-white rounded-3xl border border-navy-200/60 shadow-sm overflow-hidden grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-5 bg-pastel-teal-light/30 border-r border-navy-200/60 p-8 flex flex-col justify-between space-y-8 relative">
          <div className="space-y-6 relative z-10">
            ...
            <div className="p-4 bg-white rounded-2xl border border-navy-200/60 space-y-3 text-[11px] text-navy-600 font-light shadow-3xs">
          ...
          <div className="pt-6 border-t border-navy-200/60 text-[9px] text-pastel-teal font-bold uppercase tracking-widest relative z-10 flex items-center gap-2 font-mono">
            <Sparkle className="w-3.5 h-3.5 text-pastel-peach fill-pastel-peach/20 animate-pulse" />
        ...
        <div className="lg:col-span-7 p-6 sm:p-8 space-y-6 bg-white">
          <div className="border-b border-navy-100 pb-3">
            ...
            <p className="text-xs text-navy-400 mt-0.5">Lengkapi rincian berikut untuk meluncurkan etalase toko digital Anda.</p>
          </div>

          <form onSubmit={onSubmit} className="space-y-5 text-xs">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                <Label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Nama Toko / UMKM</Label>
                <Input
                  type="text"
                  required
              ...
              <div className="space-y-1">
                <Label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Nama Pemilik</Label>
                <Input
                  type="text"
                  required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                <Label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Nomor WhatsApp Toko</Label>
                <Input
                  type="tel"
                  required
              ...
              <div className="space-y-1">
                <label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Wilayah Dusun</label>
                <select
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                <Label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Jam Kerja Operasional</Label>
              ...
              <div className="space-y-1">
                <Label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Fokus Sektor Usaha</Label>
                <select
            ...
            <div className="space-y-1">
              <Label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Alamat Detail Produksi</Label>
              <Input
                type="text"
                required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                <Label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Logo Toko (Opsional)</Label>
                <Input
                  type="file"
                  accept="image/*"
              ...
              <div className="space-y-1">
                <Label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Banner Foto Toko (Opsional)</Label>
                <Input
                  type="file"
                  accept="image/*"
            ...
            <div className="space-y-1">
              <Label className="font-bold text-navy-400 uppercase tracking-wider block text-[9px]">Deskripsi Singkat Toko</Label>
              <textarea
                rows={2}
            ...
            <Button
              ...
              className="w-full h-11 bg-pastel-teal hover:bg-pastel-teal/90 text-white font-extrabold uppercase tracking-widest text-[10px] rounded-xl flex items-center justify-center gap-2 cursor-pointer shadow-xs hover:shadow-md transition-all"
            >
